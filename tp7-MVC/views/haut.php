...
<br/>
	<div class="userdata">
		 <h5 align="right">
		 	<?php
			if(isset($_SESSION["login"])){?>vous etes connecter avec le compte <?php echo strtoupper($_SESSION["login"]);?> <a href="index.php?action=deconnect">Disconnect</a> <?php }else{?>no connection<?php }?>  
			<a href="index.php?action=option">OPTION</a></h5>	 	
			<!-- <a href="">OPTION</a></h5>	 	 -->
	...
	<table>
	 <tr class="maintr" >
	  <td class="side"<?php echo "style=\"background-color:".$sideBgcolor.";\"> ";?> 
		<div class="aside" >
			<h2><a href="index.php?action=index">Acceuil</a></h2>
			<h2><a href="index.php?action=liste">Liste</a></h2>
