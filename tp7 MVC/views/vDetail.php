...
<div class="main">
		 ...
		 <?php
		    if(is_null($e)){
		 	...
		 	echo "<a href=\"index.php?action=modifier&codeE=".$e[0]."\"><input type=\"submit\"  value=\"modification\"  name=\"modification\"></a>	";
		 	echo "<a href=\"index.php?action=supprimer&?codeE=".$e[0]."\"><input type=\"submit\"  value=\"supression\"  name=\"supression\"></a>	";
